 ...
 * @author LUIS
 */
public class Personal_Intendencia extends javax.swing.JFrame {

    /**
     * Creates new form Personal_Intendencia
     */
    public Personal_Intendencia() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Personal Intendencia");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Personal_Intendencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Personal_Intendencia().setVisible(true);
            }
        });
    }
